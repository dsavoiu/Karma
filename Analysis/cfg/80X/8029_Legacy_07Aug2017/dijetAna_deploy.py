...
if __name__ == "__main__":
    ...
    _deployer = DijetAnalysisDeployerGC(
        nick="DijetAna_JetHT_Run2016G-Legacy-07Aug2017-v1_2018-08-10",
    ...
    _deployer.add_input_files("/storage/gridka-nrg/dsavoiu/Dijet/test_skims/Dijet_JetHT_Run2016G-Legacy-07Aug2017-v1_2018-08-10/*.root")
