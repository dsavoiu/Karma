...
QUANTITIES['mc'].update({
    'jet1MatchedGenJetPt_narrow':            Quantity(name='jet1MatchedGenJetPt_narrow',          expression='jet1MatchedGenJetPt',           binning=QUANTITIES['global']['jet1pt_narrow'].binning),
    'jet12MatchedGenJetPairPtAve_narrow':    Quantity(name='jet12MatchedGenJetPairPtAve_narrow',  expression='jet12MatchedGenJetPairPtAve',   binning=QUANTITIES['global']['jet12ptave_narrow'].binning),
    'jet12MatchedGenJetPairMass_narrow':     Quantity(name='jet12MatchedGenJetPairMass_narrow',   expression='jet12MatchedGenJetPairMass',    binning=QUANTITIES['global']['jet12mass_narrow'].binning),

    'jet1MatchedGenJetPt_wide':              Quantity(name='jet1MatchedGenJetPt_wide',            expression='jet1MatchedGenJetPt',           binning=QUANTITIES['global']['jet1pt_wide'].binning),
    'jet12MatchedGenJetPairPtAve_wide':      Quantity(name='jet12MatchedGenJetPairPtAve_wide',    expression='jet12MatchedGenJetPairPtAve',   binning=QUANTITIES['global']['jet12ptave_wide'].binning),
    'jet12MatchedGenJetPairMass_wide':       Quantity(name='jet12MatchedGenJetPairMass_wide',     expression='jet12MatchedGenJetPairMass',    binning=QUANTITIES['global']['jet12mass_wide'].binning),
})
