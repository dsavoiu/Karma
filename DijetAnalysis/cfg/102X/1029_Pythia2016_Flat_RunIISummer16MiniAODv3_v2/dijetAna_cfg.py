...
if not os.getenv("GC_VERSION"):
    ...
    options = (
        dijetAnalysis_94X_Run2016_17Jul2018_v2_cff.register_options(KarmaOptions())
            .setDefault('inputFiles', "root://cmsxrootd-redirectors.gridka.de//store/user/dsavoiu/Dijet/skims/KarmaSkim_QCD_Flat_Pt_15to7000_RunIISummer16MiniAODv3_2022-01-20/job_35_output.root")
