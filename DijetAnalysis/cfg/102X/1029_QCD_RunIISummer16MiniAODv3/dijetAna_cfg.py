...
if not os.getenv("GC_VERSION"):
    ...
    options = (
        dijetAnalysis_94X_Run2016_17Jul2018_cff.register_options(KarmaOptions())
            ...
            .setDefault('inputFiles', "root://cmsxrootd-redirectors.gridka.de//store/user/dsavoiu/Dijet/skims/KarmaSkim_QCD_Pt_80to120_RunIISummer16MiniAODv3_2020-01-09/job_314_output.root")
