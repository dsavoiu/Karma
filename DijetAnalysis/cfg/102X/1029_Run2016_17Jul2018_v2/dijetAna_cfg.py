...
if not os.getenv("GC_VERSION"):
    ...
    options = (
        dijetAnalysis_94X_Run2016_17Jul2018_v2_cff.register_options(KarmaOptions())
            ...
            .setDefault('inputFiles', "root://cmsxrootd-redirectors.gridka.de//store/user/dsavoiu/Dijet/skims/KarmaSkim_JetHT_Run2016G-17Jul2018-v1_2020-09-15/job_3210_output.root")
